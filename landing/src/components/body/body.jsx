...
export function Body () {
  return (
    <main>
      <div id='body'>
        <div id='carrousel375'>
          <Carrousel iconSrc='./src/assets/carrousel375.png' />
        </div>
        <div id='carrousel1025'>
        ...
        <div> <img id='giftcardimg375' src='src/assets/giftcard375.png' alt='giftcard' /></div>
        <div> <img id='giftcardimg1025' src='src/assets/giftcard.png' alt='giftcard' /></div>
